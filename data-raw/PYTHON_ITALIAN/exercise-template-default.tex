...
\usepackage{array}  % For array and tabularx environments
\usepackage{tabularx} % For tabularx environment
\usepackage{calc}    % For \real command
...
% Begin section with highlights and threshold concepts
...
\begin{abstract}
    ...
    % If there are threshold concepts type them
    ...
    % Close the box for the highlights and threshold concepts with another rule
    \hbox{\vrule height .8pt width 39.14pc}

% If there are not highlights just create a rule
    $else$
    \hbox{\vrule height .8pt width 39.14pc}
    $endif$

% Space after the rule
\vskip 20pt
