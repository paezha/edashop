...
6. Obtain a summary of the new table but only for properties of `IPVS` "Baixíssima vulnerabilidade".

7. Obtain a summary of the new table but only for properties _not_ of `IPVS` "Baixíssima vulnerabilidade".
